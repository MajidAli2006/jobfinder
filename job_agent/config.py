...
#: The widest window a request is allowed to ask for. Past this, boards are
#: returning adverts that have already been filled.
...
#: What a salary is almost certainly quoted in, when an advert gives a figure
#: and no currency. Every country the region table knows has an entry, so a
#: figure from one market is never read as though it were dollars.
COUNTRY_TO_CURRENCY = {
    ...
    "Netherlands": "EUR", "Belgium": "EUR", "Switzerland": "CHF",
    "Austria": "EUR", "Italy": "EUR", "Poland": "PLN", "Sweden": "SEK",
    "Norway": "NOK", "Denmark": "DKK", "Finland": "EUR", "Czechia": "CZK",
    "Romania": "RON", "Ukraine": "UAH", "Turkey": "TRY", "India": "INR",
    "Pakistan": "PKR", "Bangladesh": "BDT", "Singapore": "SGD", "Japan": "JPY",
    "South Korea": "KRW", "China": "CNY", "Philippines": "PHP",
    "Indonesia": "IDR", "Vietnam": "VND", "United Arab Emirates": "AED",
    "Saudi Arabia": "SAR", "Israel": "ILS", "South Africa": "ZAR",
    "Nigeria": "NGN", "Kenya": "KES", "Egypt": "EGP", "Brazil": "BRL",
    "Mexico": "MXN", "Argentina": "ARS", "Colombia": "COP", "Chile": "CLP",
}
...
CURRENCY_TO_USD = {
    ...
    "CNY": 0.14, "KRW": 0.00072, "COP": 0.00024, "CLP": 0.00104,
}
...
CITY_COUNTRY = {
    ...
    "belfast": "united kingdom", "liverpool": "united kingdom",
    "sheffield": "united kingdom", "newcastle": "united kingdom",
    "nottingham": "united kingdom", "cambridge": "united kingdom",
    "oxford": "united kingdom", "reading": "united kingdom",
    "brighton": "united kingdom", "dundee": "united kingdom",
    "leicester": "united kingdom", "aberdeen": "united kingdom",
    "rijeka": "croatia", "split": "croatia",
...
#: US state abbreviations. Half of them are also ISO country codes — CA is
#: California and Canada, DE is Delaware and Germany, IN is Indiana and India —
#: so a bare two-letter code is only ever read alongside the rest of the string.
